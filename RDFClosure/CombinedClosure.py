...
class RDFS_OWLRL_Semantics(RDFS_Semantics, OWLRL_Semantics):
    ...
    @ivar full_binding_triples: additional axiom type triples that are added to the combined semantics; these 'bind'
    the RDFS and the OWL worlds together
    @ivar rdfs: whether RDFS inference is to be performed or not. In this class instance the value is I{always} C{True},
    subclasses may explicitly change it at initialization time.
    @type rdfs: boolean
    """
