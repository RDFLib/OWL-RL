...
"""
$Id: RDFSClosure.py,v 1.15 2011/08/04 12:41:58 ivan Exp $ $Date: 2011/08/04 12:41:58 $
"""
...
class RDFS_Semantics(Core) :
	...
	def add_axioms(self) :
		"""Add axioms
		"""
		for t in RDFS_Axiomatic_Triples : self.graph.add(t)
	...
	def add_d_axioms(self) :
		...
		for t in RDFS_D_Axiomatic_Triples : self.graph.add(t)
	...
	def rules(self,t,cycle_num) :
		...
		# rdfs4a
		if cycle_num == 1 : self.store_triple((s, type, Resource))
		# rdfs4b
		if cycle_num == 1 : self.store_triple((o, type, Resource))
		if p == domain :
			# rdfs2
