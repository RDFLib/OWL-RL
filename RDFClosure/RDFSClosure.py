...
class RDFS_Semantics(Core):
    ...
    The comments and references to the various rule follow the names as used in the U{RDF Semantics
    document<http://www.w3.org/TR/rdf-mt/>}.
    """
